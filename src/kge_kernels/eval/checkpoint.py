...
def evaluate_checkpoint(
    ...
    *,
    ...
    valid_path = resolve_split_path(
        ...
        dataset=cfg.dataset, data_root=cfg.data_root, split_filename=cfg.valid_split,
    )
    if valid_path:
    ...
    test_path = resolve_split_path(
        ...
        dataset=cfg.dataset, data_root=cfg.data_root, split_filename=cfg.test_split,
    )
    if test_path:
    ...
    head_domain, tail_domain = (
        build_relation_domains(triples + valid_triples + test_triples)
        if use_domain_eval else (None, None)
    )
